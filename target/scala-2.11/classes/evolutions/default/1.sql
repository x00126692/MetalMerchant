...
create table genre_article (
  genre_id                      bigint not null,
  article_id                    bigint not null,
  constraint pk_genre_article primary key (genre_id,article_id)
);
...
alter table genre_article add constraint fk_genre_article_genre foreign key (genre_id) references genre (id) on delete restrict on update restrict;
create index ix_genre_article_genre on genre_article (genre_id);

alter table genre_article add constraint fk_genre_article_article foreign key (article_id) references article (id) on delete restrict on update restrict;
create index ix_genre_article_article on genre_article (article_id);
...
alter table genre_article drop constraint if exists fk_genre_article_genre;
drop index if exists ix_genre_article_genre;

alter table genre_article drop constraint if exists fk_genre_article_article;
drop index if exists ix_genre_article_article;
...
drop table if exists genre_article;
